 ...
 */
$config_directories = array(
CONFIG_SYNC_DIRECTORY => 'config_0789bac9b1d27c2be1f425695f13297760a69a84
',
    );
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_cdcrnewssandbox_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_cdcrnewssandbox_dev_default.inc';
}
// </DDSETTINGS>
...
// (Drupal 5 or 6) or $databases (Drupal 7 or 8) as described in comments above.
if (file_exists('/var/www/site-php')) {
  require('/var/www/site-php/cdcrnewssandbox/cdcrnewssandbox-settings.inc');
}
